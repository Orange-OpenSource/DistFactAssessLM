...
from _old_codebase.build.utils.wd import adapt_name
from _old_codebase.build.gpt3_5_verbalization.utils import (
    parallel_verbalize,
    Entity,
    KnowledgeTriple,
    Literal,
...
from _old_codebase.build.utils.wd import db, get_info_wikidata, get_value
