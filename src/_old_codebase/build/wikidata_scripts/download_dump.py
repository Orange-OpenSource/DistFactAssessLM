...
parser.add_argument('--version', type=str, help='The Wikidata version to download (old or new)', choices=['old', 'new'], required=False)
parser.add_argument('--date', type=str, help='The date of the Wikidata dump', required=False)
