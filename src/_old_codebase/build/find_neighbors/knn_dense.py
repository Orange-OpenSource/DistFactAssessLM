...
from _old_codebase.find_neighbors.scripts.generate_entity_label_embedding import main as main_generate_label_embedding
from _old_codebase.find_neighbors.scripts.index_with_nmslib import main as main_nmslib_index
