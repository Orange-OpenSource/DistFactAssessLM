...
from _old_codebase.build.verbalize_wikifactdiff.utils import blank_out
from glob_core import MongoableEnum
from globals import STORAGE_FOLDER
from kb.core import Relation
from utils.general import dump_json, load_json
from verb.core import Template, TemplateVerbalizer
...
class WikiFactDiffVerbalizer(TemplateVerbalizer):
